...
class LabelTool():
    ...
    def loadDir(self, dbg = False):
        ...
        if len(self.imageList) == 0:
            ...
            tkmb.showerror("Error!", message = "No .jpg images found in the specified dir!")
            return
    ...
    def prevImage(self, event = None):
        ...
        if self.cur > 1:
            ...
            tkmb.showerror("Information!", message = "This is first image")
    ...
    def nextImage(self, event = None):
        ...
        if self.cur < self.total:
            ...
            tkmb.showerror("Information!", message = "All images annotated")
